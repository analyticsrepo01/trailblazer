...
def get_tokenizer_model():
    # Create tokenizer
    tokenizer = AutoTokenizer.from_pretrained(name) #cache_dir='./model/',use_auth_token=False

    # Create model
    model = AutoModelForCausalLM.from_pretrained(name, torch_dtype=torch.float16, 
                            rope_scaling={"type": "dynamic", "factor": 2}, load_in_8bit=True) #cache_dir='./model/' , use_auth_token=False
